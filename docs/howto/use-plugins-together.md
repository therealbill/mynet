...
- [How to Install a Plugin](../install-a-plugin/) -- add or remove plugins as your workflow changes
- [How to Find the Right Plugin](../find-right-plugin/) -- discover additional plugins to extend your workflow
- [Marketplace Explanation](../../explanation/) -- understand how plugins, agents, and skills interact
